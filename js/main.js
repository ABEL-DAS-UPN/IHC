...
function openLoginWindow() {
    window.open("login.html", "loginWindow", "width=1223,height=624,top=50%,left=50%,scrollbars=yes");
  }
function openLoginWindowReclamacion(){
    window.open("reclamaciones.html", "loginWindow","width=1223,height=624,top=50%,left=50%");
}